...
declare const OPEN_COAI_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof OPEN_COAI_LIBC === "undefined" ? undefined : OPEN_COAI_LIBC
...
export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.OPEN_COAI_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.OPEN_COAI_EXPERIMENTAL_FILEWATCHER) {
