...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OPEN_COAI_CALLER", () => {
    process.env["OPEN_COAI_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OPEN_COAI_CALLER", () => {
    process.env["OPEN_COAI_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OPEN_COAI_CALLER", () => {
    process.env["OPEN_COAI_CALLER"] = "unknown"
