...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      OPEN_COAI_EXPERIMENTAL_WORKSPACES: Flag.OPEN_COAI_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.OPEN_COAI_EXPERIMENTAL_WORKSPACES = original.OPEN_COAI_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
