...
describe("opencode read-only commands (smoke)", () => {
  ...
  // OPEN_COAI_CONFIG_CONTENT={} we provide, no servers should be configured
  ...
  // `session list` reads the session DB. Fresh OPEN_COAI_TEST_HOME means
  ...
  // in production it'd be a path under OPEN_COAI_TEST_HOME / XDG_DATA_HOME.
