...
const releaseId = process.env.OPEN_COAI_RELEASE
if (!releaseId) throw new Error("OPEN_COAI_RELEASE is required")

const version = process.env.OPEN_COAI_VERSION
if (!version) throw new Error("OPEN_COAI_VERSION is required")
